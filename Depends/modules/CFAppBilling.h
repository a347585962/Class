...
#ifndef __MysteryGuardians__CFAppBilling__
#define __MysteryGuardians__CFAppBilling__

class CFAppBillingDelegate;
...
public:
    ...
    void setIABDelegate(CFAppBillingDelegate* pDelegate);
...
public:
    ...
    virtual void purchaseSuccessfulNocallback(const char* pid) = 0;
...
#endif /* defined(__MysteryGuardians__CFAppBilling__) */
